      ...
      <div className='container'>
        ...
        <div className='row justify-content-md-center text-center pb-5'>
          ...
          <div className='col-lg-4'>
            <div className='card mb-md-0 mb-3'>
              <div className='card-body py-4'>
                <SlLocationPin className='display-4 mb-2 text-warning' />
                <strong className='mb-2 d-block h4'>Location</strong>
                <a style={{ textDecoration: 'none' }} href='https://goo.gl/maps/hc3BnGU3tkoXZVm1A' target={'_blank'} rel="noreferrer" itemProp='location'><h5 className='mb-4 text-primary'>FitnessHub GYM Derabassi</h5></a>
              </div>
            </div>
          </div>
          ...
          <div className='col-lg-4'>
            <div className='card mb-md-0 mb-3'>
              <div className='card-body py-4'>
                <BsTelephoneFill className='display-4 mb-2 text-warning' />
          ...
          <div className='col-lg-4'>
            <div className='card mb-md-0 mb-3'>
              <div className='card-body py-4'>
                <SiGmail className='display-4 mb-2 text-warning' />
                <strong className='mb-2 d-block h4'>E-Mail</strong>
                <a style={{ textDecoration: 'none' }} href='mailto:deep6421@gmail.com' target="_top" rel="noreferrer" itemProp='email'><h5 className='mb-4 text-primary'>info@fitnesshub.com</h5></a>
              </div>
            </div>
          </div>
